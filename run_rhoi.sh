...
python run_rhoi.py --execute_list obj_process --process_list ho3d_obj_SAM3D_filter_2D --seq_list $seq_list #--vis
python run_rhoi.py --execute_list obj_process --process_list ho3d_obj_SAM3D_gen --seq_list $seq_list #--vis
python run_rhoi.py --execute_list obj_process --process_list ho3d_obj_SAM3D_filter_3D --seq_list $seq_list #--vis

# python run_rhoi.py --execute_list obj_process --process_list ho3d_obj_SAM3D_post_opt_GS --seq_list $seq_list --rebuild
python run_rhoi.py --execute_list obj_process --process_list ho3d_align_SAM3D_mask --seq_list $seq_list #--vis
python run_rhoi.py --execute_list obj_process --process_list ho3d_align_SAM3D_pts --seq_list $seq_list #--vis
python run_rhoi.py --execute_list obj_process --process_list ho3d_align_SAM3D_fp --seq_list $seq_list --rebuild  #--vis

# Filter aligned frames by depth 3-axis coverage
python run_rhoi.py --execute_list obj_process --process_list pipeline_sam3d_align_filter --seq_list $seq_list --rebuild  #--vis
python run_rhoi.py --execute_list obj_process --process_list pipeline_sam3d_delete_unused --seq_list $seq_list
python run_rhoi.py --execute_list obj_process --process_list pipeline_sam3d_best_id --seq_list $seq_list  #--vis
...
python run_rhoi.py --execute_list data_convert --process_list get_depth_from_foundation_stereo soft_link_depth --seq_list $seq_list --rebuild # only for zed dataset
# python run_rhoi.py --execute_list data_convert --process_list ho3d_inpaint --seq_list $seq_list
...
# python run_rhoi.py --execute_list data_convert --process_list hot3d_sync_hands_to_local --seq_list $seq_list --rebuild
